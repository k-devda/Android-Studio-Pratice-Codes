    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(icon: Icon(Icons.camera_alt,color: Colors.white,),onPressed:() {}, tooltip: "Cammera",),
            IconButton(icon: Icon(Icons.search,color: Colors.white,) ,onPressed: () {} , tooltip: "Search",),
            IconButton(icon: Icon(Icons.more_vert,color: Colors.white,),onPressed: () {}, tooltip: "Menu",),
          ],

          bottom: TabBar(
            tabs:
            [
              Tab(icon: Icon(Icons.chat_outlined,color: Colors.white,),
                child: Text(
                  "Chats",
                  style: TextStyle(color: Colors.white),
                ),),
              Tab(icon: Icon(Icons.update,color: Colors.white,),
                  child:Text(
                    "Updates",
                    style: TextStyle(color: Colors.white,),
                  ),),
